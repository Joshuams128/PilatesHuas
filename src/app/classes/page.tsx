    ...
    <div className="w-full">
        ...
        <div className="max-w-[1440px] mx-auto px-6">
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {classes.map((classItem, index) => (
              ...
              >
                <h3 className="font-['Stolen_Love'] text-3xl mb-4 text-[#1A1410]">
                  {classItem.name}
                </h3>
                <span
                  className={`inline-block px-4 py-2 ${getDifficultyColor(
                    classItem.difficulty
                  )} text-white text-sm font-['Stolen_Love'] rounded-full mb-6`}
                >
                  {classItem.difficulty}
                </span>
                <p className="font-['Stolen_Love'] text-[#1A1410] leading-relaxed mb-6">
                  {classItem.description}
                </p>
                <Link
                  href="/book-now"
                  className="inline-block w-full px-6 py-3 bg-[#82614A] text-white font-['Stolen_Love'] rounded-full hover:bg-[#6d5038] transition text-center"
                >
                  Book This Class
                </Link>
              </div>
      ...
      <section className="py-20 bg-[#D9D2C6]">
        <div className="max-w-[1440px] mx-auto px-6 text-center">
          ...
          <p className="font-['Stolen_Love'] text-xl mb-8 text-[#1A1410] max-w-2xl mx-auto">
